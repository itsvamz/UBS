  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative py-28 md:py-32 min-h-screen overflow-hidden w-full bg-cover bg-center">
        ...
        <img src="https://github.com/itsvamz/UBS/blob/main/frontend/hero.jpeg?raw=true" alt="Hero Image" className="absolute inset-0 w-full h-full object-cover z-0 opacity-25" />
